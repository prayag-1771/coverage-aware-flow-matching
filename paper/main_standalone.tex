...
Table~
\ref{tab:hyper} lists every setting. Table~\ref{tab:hyper} lists every setting used. Neither classifier is tuned per arm. A per-arm search would confound the

...
ADASYN~\cite{he2008adasyn} biases that sampling toward records whose neighbourhoods are dominated by other classes, Both remain the practical default in intrusion detection: recent work continues to build pipelines around them~\cite{abdelkhalek2023addressing,gmmadasyn2024overcoming}. Both are two decades old, both are available in one

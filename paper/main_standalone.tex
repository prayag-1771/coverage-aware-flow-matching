...
reality that intrusions continue to succeed---a gap Sommer and Paxson
identified as structural to this problem rather than incidental
\cite{sommer2010outside}, those figures invite a question
...
ADASYN~\cite{he2008adasyn} biases that sampling toward records whose neighbourhoods are dominated by other classes, and Borderline-SMOTE~\cite{han2005borderline} restricts synthesis to samples near the decision boundary. Johnson and Khoshgoftaar survey the wider family and its deep-learning successors~\cite{johnson2019survey}. Both are two decades old, both are available in one
...
CTGAN~\cite{xu2019modeling} adapts adversarial training~\cite{goodfellow2014gan}
to tabular data through
...
Three benchmarks are used, summarised in Table~\ref{tab:datasets}. Surveys of the
available options and their limitations are given by Ring et
al.~\cite{ring2019survey} and, more recently, by Goldschmidt and
Chud\'{a}~\cite{goldschmidt2025network}. Ours are chosen to

...
The three datasets analysed in this study are publicly available: NSL-KDD, UNSW-NB15
and CICIDS2017, from their respective distributors as cited in the Methods. The code,
the complete per-run result files, and the scripts that generate every table and
figure in this paper will be made publicly available upon publication at
\url{https://github.com/prayag-1771/coverage-aware-flow-matching}, and are available
from the corresponding author on reasonable request in the interim.

...
improvements have bootstrap confidence intervals excluding zero and six survive
Holm--Bonferroni correction. The largest raises user-to-root F1 by $85.6\%$
relative, from $0.2193$ to $0.4070$ at $p=0.0021$ with Cohen's $d=4.68$, on a class
represented by 52 training records against a majority of 67,343. Remote-to-local
gains $50.5\%$ and UNSW-NB15 Backdoor $64.9\%$. All four generative families
contribute at least one solid improvement, across both benchmarks whose rare classes
appear in training and test. Two settings taken as standard in this literature can
